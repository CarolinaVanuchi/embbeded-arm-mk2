...
void app_main(void)
{
    ...
    xTaskCreate(task_motor_base, "task_base", 1024 * 2, NULL, configMAX_PRIORITIES - 3, NULL);
    ...
    // xTaskCreate(task_end_base, "task_end_base", 1024, NULL, configMAX_PRIORITIES - 4, NULL);
